...
/***********************************/
header int_custom_shim_t{
    bit<6> original_dscp;
    bit<2> reserved;
    bit<8> int_total_words;
...
header int_metadata_stack_t {
    ...
    MD included: 
    - in & eg ifs     = 2 * 16 = 32
    - in & eg tstamps = 2 * 64 = 128 
    - Node ID         = 1 * 32 = 32
    - Byte Counter    = 1 * 64 = 64 
    - Packet Counter  = 1 * 32 = 32 
                     subTotal  = 288
    Total: subTotal * number of nodes
              288   *   3      = 576 bits
    */
...
/***** Application specific headers *****/
    int_custom_shim_t           int_custom_shim;
    int_custom_md_header_t      int_custom_md;
}
