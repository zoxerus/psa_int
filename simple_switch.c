/* Automatically generated by p4c-ebpf from simple_switch.p4 on Tue May  2 16:54:34 2023
 */
...
;
                                                                meta->ingress_timestamp = (u64)istd.ingress_timestamp;
...
;
        ...
        if (parsed_hdr->umeta.ebpf_valid) {
            ...
            ebpf_byte = ((char*)(&parsed_hdr->umeta.markToCloneE2E))[0];
...
/* extract(parsed_hdr->umeta) */
            ...
            parsed_hdr->umeta.markToCloneE2E = (u8)((load_byte(pkt, BYTES(ebpf_packetOffsetInBits)) >> 6) & EBPF_MASK(u8, 1));
            ebpf_packetOffsetInBits += 1;

            parsed_hdr->umeta.padding = (u8)((load_byte(pkt, BYTES(ebpf_packetOffsetInBits))) & EBPF_MASK(u8, 6));
            ebpf_packetOffsetInBits += 6;

            parsed_hdr->umeta.ingress_port = (u32)((load_word(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 32;

            parsed_hdr->umeta.ingress_timestamp = (u64)((load_dword(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 64;
